        ...
        <div className="space-y-6">
          <div>
            ...
            {data.detailedProposalFile ? (
              <a href={data.detailedProposalFile} target="_blank" rel="noreferrer" className="inline-flex items-center space-x-2 text-indigo-600 hover:text-indigo-800 font-medium bg-indigo-50 px-4 py-2 rounded-lg transition-colors">
